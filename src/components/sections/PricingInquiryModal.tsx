...
const PricingInquiryModal = ({ open, service, onClose }: PricingInquiryModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-ink/40 px-4 pt-24 sm:items-center sm:pt-0">
      <div className="w-full max-w-[640px] rounded-3xl border border-line bg-paper p-6 shadow-[0_20px_50px_rgba(0,0,0,0.18)]">
        ...
        {isSubmitSuccessful || submitError ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 grid gap-4 text-sm text-ink/70">
